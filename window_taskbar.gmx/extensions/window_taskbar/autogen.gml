...
var _buf = window_taskbar_prepare_buffer(28);
...
return window_progress_raw(buffer_get_address(_buf));

#define window_flash
/// window_flash(flags:int, count:int = 0, freq:int = 0)->bool
var _buf = window_taskbar_prepare_buffer(20);
buffer_write(_buf, buffer_u64, int64(window_handle()));
buffer_write(_buf, buffer_s32, argument[0]);
if (argument_count >= 2) {
	buffer_write(_buf, buffer_bool, true);
...
return window_flash_raw(buffer_get_address(_buf));
