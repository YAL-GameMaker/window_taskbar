...
set extName=window_taskbar
set dllName=window_taskbar
set gmlDir14=%solutionDir%window_taskbar.gmx
set gmlDir22=%solutionDir%window_taskbar_yy
set gmlDir23=%solutionDir%window_taskbar_23
